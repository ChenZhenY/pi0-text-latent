...
import openpi.models.pi0_linear_probing as pi0_linear_probing
...
class TrainConfig:
    ...
    model: _model.BaseModelConfig = dataclasses.field(default_factory=pi0_linear_probing.Pi0Config)
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_aloha",
        model=pi0_linear_probing.Pi0Config(),
    ...
    TrainConfig(
        name="pi0_droid",
        model=pi0_linear_probing.Pi0Config(action_horizon=10),
    ...
    TrainConfig(
        ...
        model=pi0_linear_probing.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="physical-intelligence/libero",
        ...
        # you chose above.
        freeze_filter=pi0_linear_probing.Pi0Config(
    ...
    TrainConfig(
        ...
        data=FakeDataConfig(),
        batch_size=2,
        model=pi0_linear_probing.Pi0Config(paligemma_variant="dummy", action_expert_variant="dummy"),
        save_interval=100,
        overwrite=True,
        exp_name="debug",
        num_train_steps=10,
